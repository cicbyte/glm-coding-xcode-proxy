...
![Xcode Settings 入口](images/001-setting.png)

配置智谱官方地址 `https://open.bigmodel.cn/api/anthropic`：

![配置智谱官方地址](images/002-bigmodel.png)

但直接使用官方地址发送对话请求时，会因响应中缺少必要字段导致解码失败：

![直接使用官方地址报错](images/003-error.png)
...
![配置本地代理](images/004-proxy.png)

配置完成后即可正常使用 AI 对话：

![通过代理正常对话](images/005-proxy-success.png)
